...
class _AdminLoginPageState extends State<AdminLoginPage> {
  ...
  Future<void> _login() async {
    ...
    final adminPassword =
        prefs.getString('admin_password') ?? await AdminCredentials.password;
    ...
    if (_usernameController.text == adminUsername &&
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
              'نام کاربری یا رمز عبور اشتباه است. ${3 - _failedAttempts} تلاش دیگر باقی مانده'),
  ...
  Widget build(BuildContext context) {
    return ResponsiveHelper.wrapWithDesktopConstraint(
      ...
      backgroundColor:
          Colors.blue.shade800, // حاشیه‌های چپ و راست آبی تیره برای ورود ادمین
    );
  }
